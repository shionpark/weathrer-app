      ...
      >
        <div className="mb-2 flex items-start justify-between gap-2">
          <div className="min-w-0">
            <h3 className="truncate font-medium">{favorite.alias}</h3>
            <p className="truncate text-xs text-gray-500">{favorite.name}</p>
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={handleEditOpen}
              aria-label="별칭 수정"
              className="rounded-md p-1 text-gray-500 transition hover:bg-gray-100 hover:text-blue-600"
            >
              <svg
            ...
            <button
              ...
              aria-label="즐겨찾기 삭제"
              className="rounded-md p-1 text-gray-500 transition hover:bg-gray-100 hover:text-red-600"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
